...
\begin{document}
	...
	\begin{resume}
		...
		\vspace{-0.5cm}
		\section{\sc Talks}
		{\bf Distorted Astrophysical Discs}\hfill {\bf May, 2020 (Postponed due to Covid-19)}\\
		...
		{\bf Computational Astrophysics} \hfill {\bf November, 2019}\\
		Gave two post-graduate level lectures on computational astrophysics reviewing hydrodynamics and modelling shockwaves.
		...
		\begin{list2}
			\item Founder of Astronomy on Tap Copenhagen.
			\item Treasurer of Kvinder i Fysik (the Danish women in physics society)
...
\begin{list1}
	\item[]{\bf Kuruwita et al.}, \emph{The dependence of episodic accretion on eccentricity during the formation of binary stars}, 2020, Astronomy \& Astrophysics, \emph{Accepted}
	\begin{list2}
