...
%		\begin{list1}
%			\item[] {\bf Kuruwita et al.}, \emph{The role of turbulence during the formation of circumbinary discs}, {\sl Submitted to MNRAS}
%			\begin{list2}
...
%			\begin{list2}
%				\item Lead author and conductor of research and analysis.\\ Collected the majority of observations.
%			\end{list2}
...
%			\begin{list2}
%				\item Obtained observational data with Keck.\\
%			\end{list2}
